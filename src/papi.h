...
typedef enum {
    ...
    PAPI_DEV_ATTR__CUDA_UINT_L2_CACHE_SIZE,
    PAPI_DEV_ATTR__CUDA_UINT_L1_GLOBAL_CACHE_SUPPORTED,
    PAPI_DEV_ATTR__CUDA_UINT_L1_LOCAL_CACHE_SUPPORTED,
    PAPI_DEV_ATTR__CUDA_UINT_L2_MAX_PERSISTING_CACHE_SIZE,
    ...
    PAPI_DEV_ATTR__ROCM_UINT_L1_CACHE_SIZE,
    PAPI_DEV_ATTR__ROCM_UINT_L2_CACHE_SIZE,
